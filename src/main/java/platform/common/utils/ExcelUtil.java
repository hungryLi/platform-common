    ...
    public static void setValue(HSSFSheet sheet, int row, int cell, Object value, CellStyle cellStyle){
        ...
        if(value==null){
            ...
            if (isCellDateFormatted(cellStyle)) {
                ...
                cellIn.setCellValue((Integer)value);
            } else if(value instanceof Double){
                cellIn.setCellValue((Double)value);
            } else if(value instanceof Short){
                cellIn.setCellValue((Short)value);
            }else if(value instanceof Long){
                cellIn.setCellValue((Long)value);
            }else if(value instanceof Float){
                cellIn.setCellValue((Float)value);
            }else if(value instanceof BigDecimal){
                cellIn.setCellValue(((BigDecimal) value).doubleValue());
            }else if(value instanceof Date){
                cellIn.setCellValue(TimeUtil.dateToString((Date)value, "yyyy-MM-dd"));
            }else{
            	cellIn.setCellValue(new HSSFRichTextString(
